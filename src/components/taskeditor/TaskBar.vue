<template>
    <div class="taskbar flex">
        ...
        <div class="taskbarfield p-field">            
            <Dropdown  v-model="selectedCodeType" :options="codeOptions" 
                placeholder="Select Code Style" label="Code Style"/>            
        </div>
        <div class="taskbarfield p-field">
        <Dropdown v-model="selectedVersion"  :options="codeTypeVersions"
                :disabled="!selectedCodeType" label="Code Style Version" placeholder="Select Code Version" />
        </div>
...
export default {
    ...
    computed: {
        ...
        {       
            ...
            const taskBasicsOK = ((this.newTask && this.currentName != '') || (this.task.name != null && this.taskVersion.version != null));
