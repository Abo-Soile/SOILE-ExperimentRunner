<template>
    <Dialog v-model:visible="dialogVisible" modal :header="'Select ' + objectType "  :style="{ width: '50vw' }">
        ...
        <template #footer>
            ...
            <Button label="Select" icon="pi pi-check" @click="$emit('selected', selectionValid ? selectedVersion : false)" autofocus :disabled="!selectionValid"/>
        </template>
    </Dialog>
