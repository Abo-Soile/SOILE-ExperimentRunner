<template>
  <div>
    ...
    <div>
      ...
      <input class="baklava-input" type="text" v-model="newOutput" name="addOutput" />
      <button class="baklava-button" @click="createOutput()">Create output</button>
      <div v-for="output in currentOutputs">
        <label :for="output"> {{ output }}</label>
        <button class="baklava-button" :name="output" @click="removeOutput(output)">
          Remove output
        </button>
      </div>
    </div>
    <div>
      ...
      <input class="baklava-input" type="text" v-model="newPersistent" name="addPersistent" />
      <button class="baklava-button" @click="createPersistent()">Add Persistent</button>
      <div v-for="persistent in currentPersistent">
        <label :for="persistent"> {{ persistent }}</label>
        <button class="baklava-button" :name="persistent" @click="removePersistent(persistent)">
          Remove Persistent
        </button>
      </div>
    </div>
